...
$string['missing_security_token'] = 'Token keamanan tidak ditemukan';
$string['invalid_security_token'] = 'Token keamanan tidak valid atau sudah kedaluwarsa';
$string['invalid_activity_token'] = 'Token tidak terkait dengan aktivitas OMPDF yang valid';
$string['course_unavailable'] = 'Kursus terkait tidak tersedia';
